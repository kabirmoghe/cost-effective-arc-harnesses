...
6. ⏳ Writeup artifacts: cross-model Pareto figure landed (`docs/figures/cross_model_pareto.{pdf,png}`); per-architecture table integrated in this doc.
...
| File | What |
|---|---|
| `orchestrator_spec.md` | Locked spec for Reflective Orchestrator (tools, exit paths, fuses) |
...
- ARC Prize leaderboard: `arc_1_leaderboard.csv` (for the V3.2-published-harness reference point)
